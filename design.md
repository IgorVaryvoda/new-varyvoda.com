...
- Homepage hero phrases stay on one line. They use a subtle dotted underline at rest and one continuous native wave on hover or keyboard focus.
- Use the animated tiled wave only for the small latest-post link.
