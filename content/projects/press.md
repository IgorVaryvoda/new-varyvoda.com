...
role: "Creator, designer and builder, with AI-assisted development"
stewardship:
  state: "evolving"
...
## A detour, still finding its shape

[Studio](/projects/sirv-studio/) is my main project. Press is a change of pace: a different stack, a smaller app and image work I can try on my own files. Like everything else I build now, it's AI-assisted.

[ImageGuide](/projects/imageguide/) audits images on the web. Press works on the files on your computer. Where it goes next, I'll find out by using it. [The build story](/posts/press-a-pleasant-detour-into-desktop-software/) covers why I started.
