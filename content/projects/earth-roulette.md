...
The fares come from cached provider data, not live seats, and the page tells you to recheck the price before booking. Wanderer checks that the return date works, the trip length fits and every month in your travel window gets searched.

The paid membership has checkout, activation, saved preferences and a recurring digest. It's too early for subscriber or retention numbers.

My first homepage version let Wanderer push the Spin button off the page. Less than two hours later I put it back. [The build story](/posts/adding-paid-without-losing-random/) has the details.
