...
A task now carries its branch, pull request, checks and review evidence alongside its title and status. When I look away for an afternoon, the board tells me what changed.
...
<img src="/images/vibeq/vibeq-activity.jpg" alt="VibeQ Activity view showing work health, human and agent presence, plus a chronological ledger of task, branch and commit events" width="1280" height="720" loading="lazy" decoding="async"/>
...
Related changes check whether a human has taken over a branch before dispatch and verify a PR merge before closing its task.
...
Those numbers only say how big the repository is. The board says more about use: between 5 March and 9 August it received 6,228 tasks and closed 4,936 of them, from humans and agents in the same queue.
